...
Enviroment_Renderer::Enviroment_Renderer()
{
...
bool Enviroment_Renderer::onCreate()
{
...
void Enviroment_Renderer::Update(float a_deltaTime)
{
...
void Enviroment_Renderer::Destroy()
{
...
bool Enviroment_Renderer::LoadImageFromFile(std::string a_filePath, unsigned int& a_textureID)
{
