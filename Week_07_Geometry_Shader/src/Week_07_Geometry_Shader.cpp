...
Week_07_Geometry_Shader::Week_07_Geometry_Shader()
{
...
bool Week_07_Geometry_Shader::onCreate()
{
...
void Week_07_Geometry_Shader::Update(float a_deltaTime)
{
...
void Week_07_Geometry_Shader::Draw()
{
...
void Week_07_Geometry_Shader::Destroy()
{
...
bool Week_07_Geometry_Shader::LoadImageFromFile(std::string a_filePath, unsigned int& a_textureID)
{
