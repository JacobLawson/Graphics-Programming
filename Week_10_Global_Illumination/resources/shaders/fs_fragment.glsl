...
//pass these in as view space directions and positions
...
void main()
{
	...
	vec3 SSAO_Value = texture(SSAOTexture, fUV).rrr;
	...
	vec3 linearColour = albedo * (ambient + diffuse + specular) * SSAO_Value;
	//gamma correction
