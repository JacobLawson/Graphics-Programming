...
void Shadows::Update(float a_deltaTime)
{
	...
	m_shadowProjectionMatrix = depthProjectionMatrix * depthViewMatrix;
...
void Shadows::SetupFrameBuffer(unsigned int& a_fbo, unsigned int a_targetWidth, unsigned int a_targetHeight, unsigned int& a_renderTexture, unsigned int& a_depthTexture)
{
	//\======================================================================================
...
void Shadows::DrawScene(unsigned int a_ProgramID)
{
	...
	//pass throught the view matrix
	unsigned int shadowProjectionViewxUniform = glGetUniformLocation(a_ProgramID, "shadowProjectionView");
