...
class Week_07_Geometry_Shader_Grass : public Application
{
public:

	Week_07_Geometry_Shader_Grass();
	virtual ~Week_07_Geometry_Shader_Grass();
...
protected:
	...
	unsigned int m_textureID_Alpha;
