...
Week_07_Geometry_Shader_Grass::Week_07_Geometry_Shader_Grass()
{
...
bool Week_07_Geometry_Shader_Grass::onCreate()
{
...
#pragma region TRANSFORM FEEDBACK
	...
	Particle launcher;
	launcher.Type = 0.f;
	launcher.Pos = glm::vec4(0.f, 0.f, 0.f, 0.f);
...
#pragma endregion
	...
	LoadImageFromFile("../resources/images/GrassTexture.png", m_textureID);
	LoadImageFromFile("../resources/images/GrassAlpha.png", m_textureID_Alpha);
...
void Week_07_Geometry_Shader_Grass::Update(float a_deltaTime)
{
...
void Week_07_Geometry_Shader_Grass::Draw()
{
	...
	unsigned int texUniformID_A = glGetUniformLocation(m_programID, "textureAlpha");
	glUniform1i(texUniformID_A, 0);
	//set our active texture, and bind our loaded texture
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, m_textureID_Alpha);
...
void Week_07_Geometry_Shader_Grass::Destroy()
{
...
bool Week_07_Geometry_Shader_Grass::LoadImageFromFile(std::string a_filePath, unsigned int& a_textureID)
{
