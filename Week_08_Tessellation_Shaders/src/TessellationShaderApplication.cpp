...
bool TessellationShaderApplication::onCreate()
{
	...
	//load in our Texture
	LoadImageFromFile("../resources/images/Water/Water_COLOR.jpg", m_DiffuseTex);
	LoadImageFromFile("../resources/images/Water/Water_NORM.jpg", m_NormalTex);
	LoadImageFromFile("../resources/images/Water/Water_SPEC.jpg", m_SpecularTex);
	LoadImageFromFile("../resources/images/Water/Water_DISP.png", m_DisplacementTex);
	LoadImageFromFile("../resources/images/Water/Water_OCC.jpg", m_OcclusionTex);
...
void TessellationShaderApplication::Update(float a_deltaTime)
{
	...
	if (m_innerTessEdge >= 5 || m_innerTessEdge <= 0)
	{
		m_innerDirection *= -1;
	}
	...
	m_innerTessEdge += (1 * a_deltaTime) * m_innerDirection;
