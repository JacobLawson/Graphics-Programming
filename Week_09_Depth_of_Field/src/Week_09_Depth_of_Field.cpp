...
Week_09_Depth_of_Field::Week_09_Depth_of_Field()
{
...
bool Week_09_Depth_of_Field::onCreate()
{
...
void Week_09_Depth_of_Field::Update(float a_deltaTime)
{
...
void Week_09_Depth_of_Field::Draw()
{
	glBindFramebuffer(GL_FRAMEBUFFER, m_fbo);
...
void Week_09_Depth_of_Field::Destroy()
{
